...
<html>
 ...
 <body>
    ...
    <input type="button" value="Compra ropa" onclick="window.location.href='alqpel_view.php'" class="btn btn-warning disabled">
    <input type="button" value="Historial de pedidos" onclick="window.location.href='alqcons_view.php'" class="btn btn-warning disabled">
