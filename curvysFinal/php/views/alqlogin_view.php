<?php
     if (isset($_SESSION["IdCliente"]) && isset($_SESSION["IdEmpleado"])) {
          session_unset();
          session_destroy();
...
<body>
	...
	<div>
	  ...
	  <h1>Curvys, tu ropa, tus normas</h1>
	</div>
    <div class="container ">
        <!--Aplicacion-->
    ...
    <div class="form-group">
      Usuario <input type="text" name="IdEmpleado" placeholder="IdEmpleado" class="form-control">
        </div>
    <div class="form-group">
    ...
    <div class="form-group">
      Usuario <input type="text" name="IdCliente" placeholder="IdCliente" class="form-control">
        </div>
    <div class="form-group">
      Clave <input type="password" name="passcode" placeholder="passcode" class="form-control">
        </div>        
