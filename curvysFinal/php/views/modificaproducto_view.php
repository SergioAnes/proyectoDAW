...
<form id="formulario" method="post" ENCTYPE="multipart/form-data"> 
  ...
  ?>
   ...
   <input class="controls" type="text" name="codigoProducto" id="codigo" placeholder="Introduzca el codigo del producto" pattern="^(P00-)[0-9]{1,20}$" title="Ejemplo: P00-2" required>
