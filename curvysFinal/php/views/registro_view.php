...
<form id="formulario" method="post" > 
  <section class="form-register">
    ...
    <input class="controls" type="text" name="nombre" id="nombre" placeholder="Introduzca su nombre" pattern="^[a-zA-Záéíóúñ][a-zA-Záéíóúñ ªº.]{0,28}[a-zA-Záéíóúñ]$" title=" empieza y termina por letra y en medio puede tener letras, espacio, y los signos “ª”, “º” y el punto. Tiene una longitud mínima de 2 y una longitud máxima de 30." required>
    
    <input class="controls" type="text" name="apellidos1" id="apellidos1" placeholder="Introduzca su primer apellido"  pattern="^[a-zA-Záéíóúñ][a-zA-Záéíóúñ \-]{0,28}[a-zA-Záéíóúñ]$" title="Apellidos empieza y termina por letra y en medio puede tener letras, espacio y el guion. El número mínimo de caracteres que va a tener es de 2 y máximo de 30" required>
    
    <input class="controls" type="text" name="apellidos2" id="apellidos2" placeholder="Introduzca su segundo apellido"  pattern="^[a-zA-Záéíóúñ][a-zA-Záéíóúñ \-]{0,28}[a-zA-Záéíóúñ]$" title="Apellidos empieza y termina por letra y en medio puede tener letras, espacio y el guion. El número mínimo de caracteres que va a tener es de 2 y máximo de 30" required>
    ...
    title=" La contraseña debe tener al entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula. Puede tener otros símbolos" required>
