...
insert into clientes(IdCliente,nombreCliente,clienteApellido1,clienteApellido2,telefono,direccion1,direccion2,ciudad,codigoPostal,pais) values 

(103,'Pepe','Perez','Galán ','679689477','92, Calle Oca',NULL,'Madrid','28025','Spain'),

(104,'Juanito','Jimenez','Jim ','679687477','92, General Ricardos',NULL,'París','12857','France'),

(105,'Jaimito','Rodriguez','Zidane ','679697477','15, Calle Laguna',NULL,'Berlin','849161','Germany');
...
insert  into lineasProducto(lineaProducto,descripcion,image) values 

('Camisetas','Maravillosas camisetas',NULL),

('Pantalones','Increíbles pantalones',NULL)
;
...
(10100,'2003-01-06','2003-01-10','Shipped',NULL,103);
...
insert IGNORE into productos(nombreProducto,lineaProducto,descripcionProducto,cantidadStock,precioCompra) values 

('Camiseta básica','Camisetas','Care for water: producido utilizando menos agua. Etiquetamos bajo el nombre Join Life las prendas que se producen utilizando tecnologías y materias primas que nos ayudan a reducir el impacto medioambiental de nuestros productos. ',540,'33.30'),
('Pantalón pliegues','Pantalones','Pantalón de tiro alto con cintura deconstruida. Bolsillos laterales y falsos bolsillos de vivo y con solapa en espalda.',6553,'43.26')
;
...
(10100,'P-001',50,'55.09'),

(10100,'P-002',22,'75.46');
...
insert  into empleados(IdEmpleado,nombre,apellido,email) values 

(1,'Sergio','Anes','sergio.agalann@gmail.com'),

(2,'Maria','Pérez','mariaperez@gmail.com'),

(3,'Miguel','Jiménez','migueljimenez@gmail.com');
